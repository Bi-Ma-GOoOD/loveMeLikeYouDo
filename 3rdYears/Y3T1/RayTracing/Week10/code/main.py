...
def renderDoF():
    ...
    main_camera.samples_per_pixel = 101
    ...
    renderer.write_img2png('week10(1.0)_jitter_DoF-v007.png')
    # renderer.write_img2png('week10_test_Aperture-v024(1.0).png')
    # renderer.render()
    # renderer.write_img2png('week10(2.1)_NoJitter_Aperture_v003.png')       
