...
/*ให้เขียน function เพื่อทําการเติมค่า total_size ของแต่ละโหนดให้ถูกต้อง โดยการทํางานของ function
ควรจะเป็นไปในลักษณะของ postorder traversal โดยที่การ visit แต่ละโหนด คือการเติมค่า total_size ของโหนด
นั้นๆ*/
